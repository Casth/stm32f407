...
int main(void)
{
	...
	GPIOD->MODER |= (0b01 << 30);
	GPIOD->ODR &= ~(1 << 15); // set GPIOD pin 5 output to LOW
	...
	GPIOB->MODER |= (0b11 << 30);	// GPIOB pin 15
	GPIOB->MODER |= (0b11 << 28);	// GPIOB pin 14
	GPIOB->MODER |= (0b11 << 26);	// GPIOB pin 13
	GPIOB->MODER |= (0b11 << 24);	// GPIOB pin 12
	...
	GPIOD->ODR ^= (1 << 15); // toggle GPIOD pin 5 output
